type ContactType = {
  ...
  email: string;
  phone: string;
  group?: string; // Optional property for groups, assuming contacts might be categorized.
};
...
// Following contacts will be checked for errors when added to the address book
